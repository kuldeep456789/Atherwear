      ...
      <div className="grid min-h-screen lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <section className="relative hidden overflow-hidden lg:block">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-12">
            <Link to="/" className="text-2xl font-black tracking-tight text-white">AETHERWEAR</Link>
        ...
        <section className="flex items-center justify-center px-5 py-12 sm:px-8">
          <div className="w-full max-w-md">
            ...
            {/* Mobile logo */}
            <Link to="/" className="mb-6 block text-2xl font-black tracking-tight lg:hidden">AETHERWEAR</Link>
            ...
            <div className="mb-8">
              ...
              <h2 className="mt-2 text-4xl font-black tracking-tight">
                {isRegister ? 'Join Aetherwear' : 'Sign in to continue'}
              </h2>
            ...
            <p className="mt-8 text-center text-xs text-zinc-400">
              Test account: <span className="font-bold text-zinc-600 dark:text-zinc-300">customer@aetherwear.com</span> / password
            </p>
          </div>
        </section>
